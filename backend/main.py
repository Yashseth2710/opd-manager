...
from backend.api.v1 import router as v1
from backend.core.config import get_settings
from backend.core.exceptions import AppError, ValidationFailed
...
async def handle_app_error(_: Request, exc: AppError) -> JSONResponse:
    extra = {"fields": exc.fields} if isinstance(exc, ValidationFailed) else {}
    return _error(exc.status, exc.code, exc.message, **extra)
